...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "ihvisnasithmi@gmail.com", href: "mailto:ihvisnasithmi@gmail.com" },
    { icon: MapPin, label: "Location", value: "Sri Lanka", href: "#" },
    { icon: Github, label: "GitHub", value: "github.com/Visna-Sithmi", href: "https://github.com/Visna-Sithmi" },
    { icon: Linkedin, label: "LinkedIn", value: "linkedin.com/in/visna-sithmi", href: "https://www.linkedin.com/in/visna-sithmi/" },
  ];
            ...
            {contactInfo.map((item, index) => (
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/20 rounded-lg flex items-center justify-center 
                  ...
                  <item.icon className="w-4 h-4 sm:w-5 sm:h-5 text-primary group-hover:text-primary-foreground 
