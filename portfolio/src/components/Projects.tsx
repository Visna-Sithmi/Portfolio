...
import { ExternalLink, Github, BarChart3, Bot, LineChart, Database, Smartphone } from "lucide-react";
...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "CeloanBrew - Tea Plantation Management",
      description:
      ...
      icon: Bot,
      github: "https://github.com/Visna-Sithmi/CeloanBrew",
      live: "#",
    },
    {
      ...
      icon: Smartphone,
      github: "https://github.com/Visna-Sithmi",
      live: "#",
    },
    {
              ...
              >
                <div className="flex items-start justify-between mb-3 sm:mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-primary/10 rounded-xl flex items-center justify-center 
                    ...
                    <project.icon className="w-6 h-6 sm:w-7 sm:h-7 text-primary group-hover:text-primary-foreground 
